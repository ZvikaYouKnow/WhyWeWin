...
export function SignalVisual({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 400 300" fill="none">
      <path d="M30 200 L60 180 L80 210 L100 170 L120 195 L140 160 L160 190 L180 140 L200 150 L220 120 L240 155 L260 100 L280 130 L300 90 L320 110 L340 70 L370 60" stroke="#3f3f46" strokeWidth="1.5" opacity="0.4" />
      <path d="M30 200 L100 175 L180 145 L260 105 L340 70 L370 60" stroke="#6366f1" strokeWidth="2" strokeLinecap="round" />
